...
adk-rust = { version = "0.8.0", features = ["labs"] }

# Full + Labs — everything including experimental crates
adk-rust = { version = "0.8.0", features = ["full", "labs"] }
...
adk-model = { version = "0.8.0", features = ["fireworks", "together", "mistral", "perplexity", "cerebras", "sambanova", "bedrock", "azure-ai"] }
```
