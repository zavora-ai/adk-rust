...
const required = {
  ...
  'graph.runtime_held_approval': 'approval_resume_can_delegate_bearer_handling_to_the_v8_runtime',
...
const sourcePaths = [
  ...
  'adk-computer-use/examples/live_v8_form.rs', 'adk-computer-use/examples/macos_form_showcase.swift',
