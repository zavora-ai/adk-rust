...
adk-sandbox = { version = "0.9.1", features = ["process", "sandbox-native"] }

# Or pick a specific platform
adk-sandbox = { version = "0.9.1", features = ["process", "sandbox-macos"] }
adk-sandbox = { version = "0.9.1", features = ["process", "sandbox-linux"] }
```
