...
adk-model = { version = "0.9.1", features = ["gemini"] }        # Google Gemini (default)
adk-model = { version = "0.9.1", features = ["openai"] }        # OpenAI GPT-5
adk-model = { version = "0.9.1", features = ["anthropic"] }     # Anthropic Claude
adk-model = { version = "0.9.1", features = ["deepseek"] }      # DeepSeek
adk-model = { version = "0.9.1", features = ["groq"] }          # Groq (ultra-fast)
