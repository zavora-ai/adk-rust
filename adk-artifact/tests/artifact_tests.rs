...
async fn test_versioning() {
    ...
    // Load latest (v2)
    let load_resp = service.load(LoadRequest {
        app_name: "app1".to_string(),
        user_id: "user1".to_string(),
        session_id: "session1".to_string(),
        file_name: "test.txt".to_string(),
    ...
    // List versions
    let versions_resp = service.versions(VersionsRequest {
        app_name: "app1".to_string(),
        user_id: "user1".to_string(),
        session_id: "session1".to_string(),
        file_name: "test.txt".to_string(),
...
async fn test_list() {
    ...
    let list_resp = service.list(ListRequest {
        app_name: "app1".to_string(),
        user_id: "user1".to_string(),
        session_id: "session1".to_string(),
    }).await.unwrap();
...
async fn test_delete() {
    ...
    let load_result = service.load(LoadRequest {
        app_name: "app1".to_string(),
        user_id: "user1".to_string(),
        session_id: "session1".to_string(),
        file_name: "test.txt".to_string(),
