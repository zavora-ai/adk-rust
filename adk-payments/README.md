...
```toml
[dependencies]
adk-payments = { version = "0.9.2", features = ["acp"] }
```

```toml
[dependencies]
adk-payments = { version = "0.9.2", features = ["ap2", "ap2-a2a", "ap2-mcp"] }
```

```toml
[dependencies]
adk-payments = { version = "0.9.2", features = ["acp", "acp-experimental", "ap2"] }
```
