...
//!
//! This example demonstrates using artifacts with JSON configuration files.
//! It shows how to save JSON data as user-scoped artifacts and load them
//! using the LoadArtifactsTool.
//!
//! Run modes:
//!   cargo run --example chat_json -p adk-rust-guide              # Validation mode
//!   cargo run --example chat_json -p adk-rust-guide -- chat      # Interactive console
//!   cargo run --example chat_json -p adk-rust-guide -- serve     # Web server mode
