...
- typed digest-only UI/filesystem/registry/process/window postconditions that survive Rust/TypeScript wire round-trip and remain part of the exact action/approval digest;
