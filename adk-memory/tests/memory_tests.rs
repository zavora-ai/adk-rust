...
async fn test_add_and_search() {
    ...
    let search_resp = service.search(SearchRequest {
...
async fn test_multiple_sessions() {
    ...
    service.add_session("app1", "user1", "session1", vec![
        MemoryEntry {
    ...
    service.add_session("app1", "user1", "session2", vec![
        MemoryEntry {
...
async fn test_user_isolation() {
    ...
    service.add_session("app1", "user2", "session1", vec![
        MemoryEntry {
