...
```toml
[dependencies]
adk-model = { version = "0.8.0", features = ["openrouter"] }
```
...
```toml
[dependencies]
adk-rust = { version = "0.8.0", features = ["models"] }
```
...
adk-model = { version = "0.8.0", features = ["gemini"] }
adk-model = { version = "0.8.0", features = ["openai"] }
adk-model = { version = "0.8.0", features = ["xai"] }
adk-model = { version = "0.8.0", features = ["anthropic"] }
adk-model = { version = "0.8.0", features = ["deepseek"] }
adk-model = { version = "0.8.0", features = ["groq"] }
adk-model = { version = "0.8.0", features = ["ollama"] }
adk-model = { version = "0.8.0", features = ["fireworks"] }
adk-model = { version = "0.8.0", features = ["together"] }
adk-model = { version = "0.8.0", features = ["mistral"] }
adk-model = { version = "0.8.0", features = ["perplexity"] }
adk-model = { version = "0.8.0", features = ["cerebras"] }
adk-model = { version = "0.8.0", features = ["sambanova"] }
adk-model = { version = "0.8.0", features = ["bedrock"] }
adk-model = { version = "0.8.0", features = ["azure-ai"] }
```
