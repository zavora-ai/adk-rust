...
`adk-model` provides LLM integrations for the Rust Agent Development Kit ([ADK-Rust](https://github.com/zavora-ai/adk-rust)). Currently supports:
...
|----------|-------|-------------|
| Google | `gemini-3-pro-preview` | Most intelligent multimodal model with agentic capabilities |
| Google | `gemini-2.5-pro` | Advanced reasoning model |
| Google | `gemini-2.5-flash` | Latest fast model (recommended) |
| Google | `gemini-2.5-flash-lite` | Lightweight, cost-effective |
| Google | `gemini-2.0-flash` | Fast and efficient |
| Google | `gemini-2.0-flash-lite` | Lightweight 2.0 model |
