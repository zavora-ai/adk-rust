...
async fn generate_poem(_ctx: Arc<dyn ToolContext>, args: Value) -> Result<Value, adk_core::AdkError> {
...
async fn main() -> Result<()> {
    ...
    let poem_tool = FunctionTool::new(
        "poem",
        "Returns a poem with specified number of lines",
        generate_poem,
    );
