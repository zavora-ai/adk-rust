use adk_session::{
    ...
    Neo4jSessionService, SessionService,
};
use chrono::Utc;
use serde_json::json;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("=== ADK Neo4j Session Example ===\n");

    // 1. Connect and migrate
    println!("1. Connecting to Neo4j...");
    let service = Neo4jSessionService::new(NEO4J_URI, NEO4J_USER, NEO4J_PASS).await?;
    println!("   Connected.");
