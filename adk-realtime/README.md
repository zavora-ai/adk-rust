...
```toml
[dependencies]
adk-realtime = { version = "0.9.2", features = ["openai"] }
```
...
```toml
adk-realtime = { version = "0.9.2", features = ["vertex-live"] }
```
...
```toml
adk-realtime = { version = "0.9.2", features = ["openai-webrtc"] }
```
...
```toml
adk-realtime = { version = "0.9.2", features = ["livekit", "openai"] }
```
