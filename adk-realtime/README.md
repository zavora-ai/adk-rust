...
```toml
[dependencies]
adk-realtime = { version = "0.9.1", features = ["openai"] }
```
...
```toml
adk-realtime = { version = "0.9.1", features = ["vertex-live"] }
```
...
```toml
adk-realtime = { version = "0.9.1", features = ["openai-webrtc"] }
```
...
```toml
adk-realtime = { version = "0.9.1", features = ["livekit", "openai"] }
```
