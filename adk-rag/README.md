...
```toml
[dependencies]
adk-rag = { version = "0.9.2", features = ["gemini"] }
...
```toml
adk-rag = { version = "0.9.2", features = ["openai"] }
```
...
```toml
adk-rag = { version = "0.9.2", features = ["qdrant"] }
```
...
```toml
adk-rag = { version = "0.9.2", features = ["lancedb"] }
```
...
```toml
adk-rag = { version = "0.9.2", features = ["pgvector"] }
```
...
```toml
adk-rag = { version = "0.9.2", features = ["surrealdb"] }
```
...
adk-rag = { version = "0.9.2", features = ["gemini", "qdrant"] }

# Everything
adk-rag = { version = "0.9.2", features = ["full"] }
```
