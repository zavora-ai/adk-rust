...
```toml
adk-rag = { version = "0.8.0", features = ["openai"] }
```
...
```toml
adk-rag = { version = "0.8.0", features = ["qdrant"] }
```
...
```toml
adk-rag = { version = "0.8.0", features = ["lancedb"] }
```
...
```toml
adk-rag = { version = "0.8.0", features = ["pgvector"] }
```
...
```toml
adk-rag = { version = "0.8.0", features = ["surrealdb"] }
```
...
adk-rag = { version = "0.8.0", features = ["gemini", "qdrant"] }
