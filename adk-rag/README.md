...
```toml
[dependencies]
adk-rag = { version = "0.8.1", features = ["gemini"] }
...
```toml
adk-rag = { version = "0.8.1", features = ["openai"] }
```
...
```toml
adk-rag = { version = "0.8.1", features = ["qdrant"] }
```
...
```toml
adk-rag = { version = "0.8.1", features = ["lancedb"] }
```
...
```toml
adk-rag = { version = "0.8.1", features = ["pgvector"] }
```
...
```toml
adk-rag = { version = "0.8.1", features = ["surrealdb"] }
```
...
adk-rag = { version = "0.8.1", features = ["gemini", "qdrant"] }

# Everything
adk-rag = { version = "0.8.1", features = ["full"] }
```
