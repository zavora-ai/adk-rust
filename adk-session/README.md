...
```toml
[dependencies]
adk-rust = { version = "0.8.0", features = ["sessions"] }
```
...
```toml
# SQLite
adk-session = { version = "0.8.0", features = ["sqlite"] }

# PostgreSQL
adk-session = { version = "0.8.0", features = ["postgres"] }

# Redis
adk-session = { version = "0.8.0", features = ["redis"] }
