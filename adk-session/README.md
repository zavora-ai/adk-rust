...
```toml
[dependencies]
adk-rust = { version = "0.3.2", features = ["sessions"] }
```
...
```toml
# SQLite
adk-session = { version = "0.3.2", features = ["sqlite"] }

# PostgreSQL
adk-session = { version = "0.3.2", features = ["postgres"] }

# Redis
adk-session = { version = "0.3.2", features = ["redis"] }
```
